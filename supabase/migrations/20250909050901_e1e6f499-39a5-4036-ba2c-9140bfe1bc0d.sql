-- Create ENUM types
CREATE TYPE public.user_role AS ENUM ('farmer', 'buyer', 'seller', 'admin');
...
CREATE TABLE public.products (
    ...
    seller_id UUID REFERENCES public.users(user_id) ON DELETE CASCADE,
...
CREATE TABLE public.orders (
    ...
    buyer_id UUID REFERENCES public.users(user_id) ON DELETE CASCADE,
    seller_id UUID REFERENCES public.users(user_id) ON DELETE CASCADE,
...
-- Add updated_at columns where needed and create triggers
ALTER TABLE public.users ADD COLUMN updated_at TIMESTAMP WITH TIME ZONE DEFAULT now();
ALTER TABLE public.products ADD COLUMN updated_at TIMESTAMP WITH TIME ZONE DEFAULT now();
ALTER TABLE public.recycle_listings ADD COLUMN updated_at TIMESTAMP WITH TIME ZONE DEFAULT now();
