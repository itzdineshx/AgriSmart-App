          ...
          style={
            {
              ...
              "--gradient":
                ...
                radial-gradient(circle at 60% 60%, #cd853f 10%, #cd853f00 20%), 
                radial-gradient(circle at 40% 60%, #b8860b 10%, #b8860b00 20%),
                repeating-conic-gradient(
                  from 236.84deg at 50% 50%,
                  #ffd700 0%,
                  #daa520 calc(25% / var(--repeating-conic-gradient-times)),
                  #cd853f calc(50% / var(--repeating-conic-gradient-times)), 
